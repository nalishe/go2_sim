...
def load_map(yaml_file):
    ...
    image_path = os.path.join(get_package_share_directory('go2_navigation') , 'map', map_data['image']) 
...
def main(args=None):
    ...
    yaml_file = os.path.join(get_package_share_directory('go2_navigation'), 'map', 'map.yaml')
